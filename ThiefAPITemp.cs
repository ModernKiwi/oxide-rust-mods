...
namespace Oxide.Plugins
{
    ...
    class ThiefAPITemp : RustPlugin
    {
        ...
        void DevMessageHandler(BasePlayer player, string message, string args = null)
        {
            PrintToChat(player, $"<color={ChatPrefixColor}>{ChatPrefix}</color>: {message}", args);
        }
